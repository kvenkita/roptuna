---
title: "Comparison with Python Optuna"
output:
  rmarkdown::html_document:
    ...
    theme: flatly
vignette: >
  %\VignetteIndexEntry{Comparison with Python Optuna}
...
This vignette shows side-by-side R (roptuna) and Python (Optuna) code for common tasks.
