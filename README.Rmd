...
`roptuna` is an R implementation of the [Optuna](https://optuna.org/) hyperparameter
optimization framework (Akiba et al. 2019). It provides define-by-run search spaces,
Tree-structured Parzen Estimator (TPE) sampling, trial pruning, and persistent study
storage via SQLite.
